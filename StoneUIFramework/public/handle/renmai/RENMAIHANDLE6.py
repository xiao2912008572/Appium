...
from StoneUIFramework.public.handle.renmai.RENMAIHANDLE5 import RENMAIHANDLE5

class RENMAIHANDLE6(RENMAIHANDLE5):
#*********************************【PAGE5】人脉首页-搜索-标签列表-点击进入群聊-设置-群头像：RMSY_search_label_groupchat_menu_setting_grouphead*********************************
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-返回：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-头像：点击
...
#*********************************【PAGE5】人脉首页-搜索-标签列表-点击进入群聊-设置-群名称：RMSY_search_label_groupchat_menu_setting_groupname*********************************
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群名称-返回：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群名称-名称输入框：输入
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群名称-备注名输入框：输入
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群名称-保存：点击
...
#*********************************【PAGE5】人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期：RMSY_search_label_groupchat_menu__heatsetting_period*********************************
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期-返回：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期-每天：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期-工昨日：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期-节假日：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期-择日：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-周期-保存：点击
...
#*********************************【PAGE5】人脉首页-搜索-标签列表-点击进入群聊-热度设置-时段：RMSY_search_label_groupchat_menu__heatsetting_time*********************************
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-时段-确定：点击
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-热度设置-时段-取消：点击
