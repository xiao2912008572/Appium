...
# ******************************************************【PAGE3】意向地区 Setting_userinfo_menu_shopping_address******************************************************
    ...
    def Setting_userinfo_menu_shopping_address_alist_click(self):
        return self.p.click(self.Setting_userinfo_menu_shopping_address_alist())

    #设置:设置-基本资料-主菜单-导购机会-意向地区-已选择地区列表
    def Setting_userinfo_menu_shopping_address_hlist_click(self):
        return self.p.click(self.Setting_userinfo_menu_shopping_address_hlist())
