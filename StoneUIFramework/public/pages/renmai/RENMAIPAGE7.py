...
#*********************************【PAGE6】人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-头像：RMSY_search_label_groupchat_menu_setting_grouphead_head*********************************
    ...
    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-头像-相册
        RMSY_search_label_groupchat_menu_setting_grouphead_head_album = ("id->com.yunlu6.stone:id/tv_cloundlibrary_alumm", "人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-头像-相册")

    #定位：人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-头像-取消
        RMSY_search_label_groupchat_menu_setting_grouphead_head_cancel = ("id->com.yunlu6.stone:id/bt_commen_cancel", "人脉首页-搜索-标签列表-点击进入群聊-设置-群头像-头像-取消")