...
class SuiteController():
    def __suiteLoader(self):
        ...
        self.suite = [
            ...
            space_ArchiviesO_01,
            # test5_1 编辑企业名片
            space_BusinessCardO_01,
            # --------------------@私人空间--------------------
            # test1_1 创建私人空间
            perspace_CreateP_01,
            # test1_2 创建私人空间文件夹
            perspace_NewFloderP_01,
            # --------------------@协会空间--------------------
            # test1_1 创建协会空间
            ascspace_CreateA_01,
            # test2_1 编辑
            ...
            # test3_1 团队人事任免
            team_AssignA_01,
            # test5_1 加会员_管理员_个人_拒绝
            AddAtoPRefuseA_01,
            # test5_2 加会员_个人_个人_拒绝
            AddPtoPRefuseA_01,
            # test5_3 加会员_管理员_个人_同意
            AddAtoPAgreeA_01,
            # test5_4 加会员_个人_个人_同意
            AddPtoPAgreeA_01,
            # test5_5 加会员_管理员_企业_拒绝
            AddAtoORefuseA_01,
            # test5_6 加会员_个人_企业_拒绝
            AddPtoORefuseA_01,
            # test5_6 加会员_管理员_企业_同意
            AddAtoOAgreeA_01,
            # test5_6 加会员_管理员_企业_同意
            AddPtoOAgreeA_01,
            # test6_1 资讯发布
