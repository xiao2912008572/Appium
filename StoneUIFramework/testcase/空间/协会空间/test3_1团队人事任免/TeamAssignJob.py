...
class TeamAssignJob:
    ...
    def teamAssignJob(self, driver):
        ...
        try:
            ...
            handle.Kjlb_browseascspace_menu_team_teamedit_numeidt_jobsnumedit().clear()  #清空
            ...
            AdmNumm = int(handle.Kjlb_browseascspace_menu_team_teamedit_numeidt_jobsnumedit().text)
            ...
            SalNum = int(handle.Kjlb_browseascspace_menu_team_teamedit_numeidt_jobsnumedit().text)
            ...
            AssNum = int(handle.Kjlb_browseascspace_menu_team_teamedit_numeidt_jobsnumedit().text)
