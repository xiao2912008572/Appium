...
from StoneUIFramework.testcase.空间.协会空间.test5_4加会员_个人_个人_同意 import *
...
class AddPerVip:
    ...
    def addPerVip(self, driver, vipname):
        ...
        sleep(1)
        try:
            self.log.info('------START:test5_5加会员_个人_个人_同意.AddPerVip.py------')
            # 1.空间首页
            # handle.Kjlb_click()
            ...
            self.log.info('------END:test5_4加会员_个人_个人_同意.AddPerVip.py------')
