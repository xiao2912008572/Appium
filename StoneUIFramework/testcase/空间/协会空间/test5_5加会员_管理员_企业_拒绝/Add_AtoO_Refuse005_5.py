...
from StoneUIFramework.testcase.空间.协会空间.test5_5加会员_管理员_企业_拒绝.AddOrgVip import AddOrgVip
...
class AddAtoORefuse(unittest.TestCase):
    ...
    def setUpClass(self):#最开始执行
        ...
        self.spacename = d.cell("test007-会员",3,1)               #协会测试123
        self.orgname = d.cell("test007-会员",3,2)                 #明月
        self.phone1 = int(d.cell("test007-会员",3,3))             #账号1:17607136211
        self.password1 =  int(d.cell("test007-会员",3,4))         #密码:12345678
        self.phone2 =  int(d.cell("test007-会员",3,5))            #账号2:13027104206
        self.password2 =  int(d.cell("test007-会员",3,6))         #密码2:12345678
        #创建LoginA对象
        self.login = LoginA()
    ...
    def test_addAtoORefuse(self):
        ...
        #9.还原测试场景
            ...
            logging.error("Error_005_5 Information Add_AtoO_Refuse Outside : %s"%err)
            raise err
        finally:
            self.driver.quit()