...
# -*- coding: utf-8 -*-
from StoneUIFramework.testcase.空间.协会空间.test5_6加会员_个人_企业_拒绝 import *
...
class AddOrgVip:
    ...
    def addOrgVip(self, driver, orgname):
        ...
        sleep(1)
        try:
            self.log.info('------START:test5_6加会员_个人_企业_拒绝.AddOrgVip.py------')
            # 1.空间首页
            # handle.Kjlb_click()
            ...
            self.log.info('------END:test5_6加会员_个人_企业_拒绝.AddOrgVip.py------')
