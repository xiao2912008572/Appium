...
class NewArchivies:
    def __init__(self):#初始化测试数据
        ...
        self.title = d.cell("test008-协会资讯",2,1)#协会测试123
        self.typelist = int(d.cell("test008-协会资讯",2,2))#类型列表:经典作品
    def newarchivies(self,driver):
        ...
        #5.添加资讯
            ...
            logging.error("Error_006_1 Information NewArchivies Inside : %s"%err)
            raise err