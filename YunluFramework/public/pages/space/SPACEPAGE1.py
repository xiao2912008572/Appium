...
class SPACEPAGE1(Page):
    ...
    # 空间列表-浏览空间列表(通过ID查找)
    Kjlb_browseorgspaceByID = ("id->com.yunlu6.yunlu:id/ivCompanyLogo", "空间列表-浏览企业空间(通过ID查找)")

    # 空间列表-浏览空间列表(通过ID查找)
    def Kjlb_browseorgspaceByIDS(self):
        self.Kjlb_browseorgspaceByIDS = self.p.get_elements("id->com.yunlu6.yunlu:id/ivCompanyLogo",
                                                            "空间列表-浏览企业空间(通过ID查找)")
