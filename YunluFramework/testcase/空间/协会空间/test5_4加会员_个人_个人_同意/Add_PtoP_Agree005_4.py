...
class AddPtoPAgreeA(unittest.TestCase):
    ...
    phone3_1 = int(d.cell("test007-会员", 5, 7))  # 账号1:17786174226
    password3_1 = int(d.cell("test007-会员", 5, 8))  # 密码:88888888
    ...
    def test_addPtoPAgree(self, spacename, vipname, phone1, password1,
        ...
        try:
            ...
            assert message == vipname + '已接受%s的会员邀请' % spacename, "Error Message Handled"
