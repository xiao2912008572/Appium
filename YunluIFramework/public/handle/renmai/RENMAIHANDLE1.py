...
from YunluIFramework.public.pages.renmai.RENMAIPAGE7 import RENMAIPAGE7
...
#******************************************************【HANDLE1】******************************************************
    ...
    def RMSY_clickcontacts_click(self, n):
        return self.p.clicks(self.RMSY_clickcontacts,n)
