...
from YunluIFramework.public.handle.renmai.RENMAIHANDLE1 import RENMAIHANDLE1
...
#*********************************【PAGE1】+同步通讯录：RMSY_syscontacts*********************************
    ...
    def RMSY_syncContacts_back_click(self):
        return self.p.click(self.RMSY_syscontacts_back)
...
#*********************************【PAGE1】点击联系人：RMSY_clickcontacts*********************************
    ...
    def RMSY_contacts_contactiontype_click(self, n):
        return self.p.clicks(self.RMSY_contacts_contactiontype,n)
    ...
    def RMSY_contacts_invatationtype_click(self, n):
        return self.p.clicks(self.RMSY_contacts_invatationtype,n)
...
#*********************************【PAGE1】+搜索输入框：RMST_searchinput*********************************
    ...
    def RMSY_search_label_click(self, n):
        return self.p.clicks(self.RMSY_search_label,n)

    #定位：人脉首页-搜索-集合列表:点击
    def RMSY_search_list_click(self, n):
        return self.p.clicks(self.RMSY_search_list,n)