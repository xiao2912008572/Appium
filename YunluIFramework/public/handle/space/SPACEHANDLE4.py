__author__ = 'xiaoj'
#空间首页
from YunluIFramework.public.handle.space.SPACEHANDLE3 import SPACEHANDLE3
...
# ***************************************【PAGE3】菜单栏-编辑Kjlb_browseorgspace_menu_bcard_menu_edit***************************************
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-Logo:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_logo_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_logo)
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-联系人:获取文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_contact_text(self):
        return self.p.get_text(self.Kjlb_browseorgspace_menu_bcard_menu_edit_contact)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-联系人:清空文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_contact_clear(self):
        return self.p.clear(self.Kjlb_browseorgspace_menu_bcard_menu_edit_contact)
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-手机号:获取文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_phone_text(self):
        return self.p.get_text(self.Kjlb_browseorgspace_menu_bcard_menu_edit_phone)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-手机号:清空文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_phone_clear(self):
        return self.p.clear(self.Kjlb_browseorgspace_menu_bcard_menu_edit_phone)
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-座机号:获取文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_landline_text(self):
        return self.p.get_text(self.Kjlb_browseorgspace_menu_bcard_menu_edit_landline)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-座机号:清空文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_landline_clear(self):
        return self.p.clear(self.Kjlb_browseorgspace_menu_bcard_menu_edit_landline)
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-邮箱:获取文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_email_text(self):
        return self.p.get_text(self.Kjlb_browseorgspace_menu_bcard_menu_edit_email)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-邮箱:清空文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_email_clear(self):
        return self.p.clear(self.Kjlb_browseorgspace_menu_bcard_menu_edit_email)
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-QQ:获取文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_QQ_text(self):
        return self.p.get_text(self.Kjlb_browseorgspace_menu_bcard_menu_edit_QQ)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-QQ:清空文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_QQ_clear(self):
        return self.p.clear(self.Kjlb_browseorgspace_menu_bcard_menu_edit_QQ)
    ...
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-网站:获取文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_website_text(self):
        return self.p.get_text(self.Kjlb_browseorgspace_menu_bcard_menu_edit_website)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-网站:清空文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_website_clear(self):
        return self.p.clear(self.Kjlb_browseorgspace_menu_bcard_menu_edit_website)
