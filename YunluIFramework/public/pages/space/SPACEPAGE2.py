__author__ = 'xiaoj'
# 空间首页
from YunluIFramework.public.pages.space.SPACEPAGE1 import SPACEPAGE1
...
class SPACEPAGE2(SPACEPAGE1):
    ...
    # 空间列表-主菜单-'+机构空间'-产业角色
    Kjlb_mainmenu_newspace_industry = ("id->com.yunlu6.yunlu:id/rl_organization_industry", "定位空间列表-主菜单-'+机构空间'-产业角色失败")
    ...
    Kjlb_browseorgspace_menu_bcard = ("id->com.yunlu6.yunlu:id/btn_pop_company_info", "空间列表-浏览企业空间-菜单栏-企业名片")
    ...
    # 空间列表-浏览企业空间-菜单栏-资讯
    Kjlb_browseorgspace_menu_archivies = ("id->com.yunlu6.yunlu:id/btn_pop_company_archivies", "空间列表-浏览企业空间-菜单栏-资讯")
    ...
    Kjlb_browseascspace_addbtn_concern = ("id->com.yunlu6.yunlu:id/tv_add_favorites", "空间列表-浏览协会空间-添加按钮-取消关注")
    ...
    Kjlb_browseascspace_menu_close_yes = ("id->com.yunlu6.yunlu:id/bt_affirm", "空间列表-浏览协会空间-菜单栏-关闭-是")

    # 定位:空间列表-浏览协会空间-菜单栏-关闭-否
    Kjlb_browseascspace_menu_close_no = ("id->com.yunlu6.yunlu:id/bt_cancel", "空间列表-浏览协会空间-菜单栏-关闭-否")
