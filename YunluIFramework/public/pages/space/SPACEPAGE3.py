__author__ = 'xiaoj'
# 空间首页
from YunluIFramework.public.pages.space.SPACEPAGE2 import SPACEPAGE2
...
class SPACEPAGE3(SPACEPAGE2):
    ...
    Kjlb_browseorgspace_menu_bcard_back = ("id->com.yunlu6.yunlu:id/title_main_more_back", "空间列表-浏览企业空间-菜单栏-企业名片-返回")

    # 空间列表-浏览企业空间-菜单栏-企业名片-企业资信
    Kjlb_browseorgspace_menu_bcard_credit = ("id->com.yunlu6.yunlu:id/companycard_level", "空间列表-浏览企业空间-菜单栏-企业名片-企业资信")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏
    Kjlb_browseorgspace_menu_bcard_menu = ("id->com.yunlu6.yunlu:id/title_main_tv_more_menu", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-退出团队
    Kjlb_browseorgspace_menu_bcard_menu_quitteam = ("id->com.yunlu6.yunlu:id/bt_teamquit", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-退出团队")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-退出团队-否
    Kjlb_browseorgspace_menu_bcard_menu_quitteam_cancell = ("id->com.yunlu6.yunlu:id/bt_cancel", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-退出团队-否")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-退出团队-是
    Kjlb_browseorgspace_menu_bcard_menu_quitteam_confirm = ("id->com.yunlu6.yunlu:id/bt_affirm", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-退出团队-是")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-附近商家
    Kjlb_browseorgspace_menu_bcard_menu_nearby = ("id->com.yunlu6.yunlu:id/bt_nearby", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-附近商家")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑
    Kjlb_browseorgspace_menu_bcard_menu_edit = ("id->com.yunlu6.yunlu:id/bt_edit", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-设置
    Kjlb_browseorgspace_menu_bcard_menu_setting = ("id->com.yunlu6.yunlu:id/bt_setup", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-设置")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-关闭
    Kjlb_browseorgspace_menu_bcard_menu_close = ("id->com.yunlu6.yunlu:id/bt_close", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-关闭")

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-分享
    Kjlb_browseorgspace_menu_bcard_menu_share = ("id->com.yunlu6.yunlu:id/bt_share", "空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-分享")

    # 空间列表-浏览企业空间-菜单栏-企业名片-联系方式列表
    Kjlb_browseorgspace_menu_bcard_contact = ("id->com.yunlu6.yunlu:id/contact_icon", "空间列表-浏览企业空间-菜单栏-企业名片-联系方式列表")

    # 空间列表-浏览企业空间-菜单栏-企业名片-资讯
    Kjlb_browseorgspace_menu_bcard_archivies = ("id->com.yunlu6.yunlu:id/btn_archivie", "空间列表-浏览企业空间-菜单栏-企业名片-资讯")

    # 空间列表-浏览企业空间-菜单栏-企业名片-点击创建产品
    Kjlb_browseorgspace_menu_bcard_newpro = ("id->com.yunlu6.yunlu:id/iv_crad_build_prod", "空间列表-浏览企业空间-菜单栏-企业名片-点击创建产品")
    ...
    Kjlb_browseorgspace_menu_order_no = ("id->com.yunlu6.yunlu:id/tv_dingdan_num", "空间列表-浏览企业空间-菜单栏-订单-订单编号")
